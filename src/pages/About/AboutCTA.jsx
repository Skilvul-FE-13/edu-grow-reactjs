                        ...
                        <div className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0 ">
                            <div className="mr-auto place-self-center lg:col-span-7">
                                ...
                                <p className="dark:text-gray-400 mb-6 max-w-2xl font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl">
                                    Mulai belajar anti ribet. Berbagai macam
                                    jenis program pembelajaran dengan
                                    materi-materi terupdate serta berbagai macam
                                    Artikel menarik. Grow sekarang bersama Edu
                                    Grow GRATIS!
                                </p>
                                <Button
